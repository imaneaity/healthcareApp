...
public class AdapterDocumments extends RecyclerView.Adapter<AdapterDocumments.ExampleViewHolder> {
    ...
    public AdapterDocumments(ArrayList<Documents> docs) {
        mDocs = docs;
    }
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        holder.mTextView1.setText("Type : "+doc.getDesignation());
    }
