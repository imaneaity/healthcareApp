...
public class MiBand {
    ...
    public void getBatteryInfo(final ActionCallback callback) {
        ...
        ActionCallback ioCallback = new ActionCallback() {
            ...
            public void onSuccess(Object data) {
                BluetoothGattCharacteristic characteristic = (BluetoothGattCharacteristic) data;
                Log.e(TAG, "getBatteryInfo result " + Arrays.toString(characteristic.getValue()));
    ...
    public void setNormalNotifyListener(NotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_Notification, Profile.UUID_CHAR_NOTIFICATION, listener);
    }
