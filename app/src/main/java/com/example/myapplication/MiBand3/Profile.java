...
public class Profile {
    ...
    public static final UUID UUID_SERVICE_Notification = UUID.fromString("00001811-0000-1000-8000-00805f9b34fb");
    ...
    public static final UUID UUID_NOTIFICATION_Notification = UUID.fromString("00002901-0000-1000-8000-00805f9b34fb");
     ...
     * 通用通知0
     */
    public static final UUID UUID_CHAR_NOTIFICATION = UUID.fromString("00002a46-0000-1000-8000-00805f9b34fb");
     ...
     * 控制,如震动等
     */
    public static final UUID UUID_CHAR_CONTROL_POINT = UUID.fromString("00002a44-0000-1000-8000-00805f9b34fb");
     ...
     * 电池,只读,通知
     */
    public static final UUID UUID_CHAR_BATTERY = UUID.fromString("00000006-0000-3512-2118-0009af100700");
