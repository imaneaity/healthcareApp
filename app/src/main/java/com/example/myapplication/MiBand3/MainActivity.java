        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == menuIndex++) {
                    final ProgressDialog pd = ProgressDialog.show(MainActivity.this, "", "Dur labeur, veuillez patienter\n" +
                            "veuillez\n" +
                            ...
                            "3\n" +
                            "Accepter.\n" +
                            "Acceptez-vous de prendre Tristan comme époux? – Oui, je le veux .\n" +
                            "3 autres définitions\n" +
                            "Synonymes de vouloir\n" +
                            "Verbe\n" +
                            "recommander aimer permettre souhaiter chercher requérir\n" +
                            "14 autres synonymes\n" +
                            "Voir aussi\n" +
                            "vouloir\n......");
                    ...
                    miband.getBatteryInfo(new ActionCallback() {
                        ...
                        @Override
                        public void onFail(int errorCode, String msg) {
                            Log.d(TAG, "getBatteryInfo fail"+ errorCode + ",mgs:" + msg);
                        }
                    });
                } else if (position == menuIndex++) {
                    UserInfo userInfo = new UserInfo(20271234, 1, 24, 175, 58, "Anes", 0);
